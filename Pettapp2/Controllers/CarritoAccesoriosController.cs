...
namespace Pettapp2.Controllers
{
    public class CarritoAccesoriosController : Controller
    {
        ...
        public CarritoAccesoriosController(PetappContext context)
        {
            _context = context;
        }
        ...
        {
            var petappContext = _context.CarritoAccesorios.Include(c => c.Accesorio).Include(c => c.Carrito);
        ...
        public async Task<IActionResult> Create([Bind("CarritoAccesorioId,CarritoId,AccesorioId,Cantidad")] CarritoAccesorio carritoAccesorio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarritoAccesorioId,CarritoId,AccesorioId,Cantidad")] CarritoAccesorio carritoAccesorio)
        {
